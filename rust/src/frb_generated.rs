...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1497784847;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__mpc_engine__keygen_continue_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__mpc_engine__keygen_start_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__mpc_engine__recover_continue_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__mpc_engine__recover_start_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__mpc_engine__sign_continue_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__mpc_engine__sign_start_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
